...
@section('content')
 ...
 <!-- Styles -->
     <link href="{{ asset('css/css_catalogos/catalogos.css') }}" rel="stylesheet">
...
<body>
    <!--EDITORIAL CUCSH IMG-->
    <div class="container">
        <div><img class="editorial_cucsh" src="{{asset('img/editorial_cucsh.jpg')}}" style="width:100%;" alt="editorial_cucsh">
        </div>
    </div>
