                ...
                <div class="col">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="box form-control" id="puesto" name="puesto" value="{{ old('puesto') }}">
                        </div>
                        <div class="col-md-7">
                            <label class="font-weight-bold" for="direccion">Dirección </label>
                            <input type="text" class=" box form-control" id="direccion" name="direccion" value="{{ old('direccion') }}">
                        </div>
                        <div class="col-md-3">
                            <label class="font-weight-bold" for="telefono">Telefono </label>
                            <input type="tel" class="box form-control" id="telefono" name="telefono" value="{{ old('telefono') }}">
                        </div>
                        <div class="col-md-7">
                            <label class="font-weight-bold" for="email">Email </label>
                            <input type="email" class="box form-control" id="email" name="email" value="{{ old('email') }}">
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-7">
                            ...
                            <input type="text" class="box form-control" id="resenia" name="resenia" value="{{ old('resenia') }}">
                        </div>
                        <br>
                        <div class="col-md-7">
