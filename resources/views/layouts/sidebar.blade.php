 <nav id="sidebar">
    ...
    <ul class="list-unstyled components">
        <li>
            <a href="#admonSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
        ...
        <li>
            <a href="#articulosSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
        ...
        <li>
            <a href="#coleccionSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
        ...
        <li>
            <a href="#librosSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
        ...
        <li>
            <a href="#noticiasSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
        ...
        <li>
            <a href="#revistasSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
